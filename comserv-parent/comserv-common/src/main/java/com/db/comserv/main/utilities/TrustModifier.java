...
public class TrustModifier {
   ...
   public static void relaxHostChecking(HttpURLConnection conn,String byPassOption) 
       throws KeyManagementException, NoSuchAlgorithmException, KeyStoreException {
	   	byPassOption=byPassOption.trim();
	      if (conn instanceof HttpsURLConnection && (byPassOption.equalsIgnoreCase("hostName") || byPassOption.equalsIgnoreCase("all"))) {
	          HttpsURLConnection httpsConnection = (HttpsURLConnection) conn;
	          if(byPassOption.equalsIgnoreCase("all")){
